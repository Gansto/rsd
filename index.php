...
<div id="g-wp" class="g-wp">
	...
	<div class="container">
		...
		<div class="hp-3">
			<h2 class="h2">代理荣事达地板的4大理由，让开店更简单<p style="font-size:13px;font-family:Arial;font-weight:normal;color:#777;">4 reasons for acting on Royalstar floor make it easier to open a shop</p><em></em></h2>
			<?
		...
		<div class="hp-5">
			...
			<ul>
				...
				<li class="clearfix">
					<p class="p1">培训支持</p>
					<p class="p2">开业全方位免费系统培训，全年度各项定期培训</p>
				</li>
				<li class="clearfix">
					<p class="p1">开业支持</p>
